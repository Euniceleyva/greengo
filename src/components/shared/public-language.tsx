...
const ES_TO_EN: Record<string, string> = {
  ...
  "Cubrimos los destinos más solicitados de Cancún y la Riviera Maya: Zona Hotelera, Playa del Carmen, Tulum, Isla Mujeres, Cozumel y Xcaret.": "We cover the most requested destinations in Cancún and the Riviera Maya: Hotel Zone, Playa del Carmen, Tulum, Isla Mujeres, Cozumel and Xcaret.",
  "Ofrecemos 4 tipos de servicio: hotel a hotel, aeropuerto ↔ hotel, transporte abierto (chofer por periodo) y soluciones a medida.": "We offer 4 service types: hotel to hotel, airport ↔ hotel, open transportation with driver by period, and tailored solutions.",
  "Con gusto te conectamos con nuestro equipo por WhatsApp para atenderte directamente.": "We can connect you with our team on WhatsApp for direct assistance.",
